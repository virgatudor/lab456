...
public class AppTest
{
    ...
    public void tc2AddStudentIdNull() {
        service.deleteStudent(STUDENT_ID);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
        assertFalse(service.saveStudent(null, STUDENT_NAME, 932) == 1);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
    }
    ...
    public void tc3AddStudentIdEmpty() {
        service.deleteStudent(STUDENT_ID);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
        assertFalse(service.saveStudent("", STUDENT_NAME, 932) == 1);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
    }
    ...
    public void tc4AddStudentNameNull() {
        service.deleteStudent(STUDENT_ID);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
        assertFalse(service.saveStudent(STUDENT_ID, null, 932) == 1);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
    }
    ...
    public void tc5AddStudentNameEmpty() {
        service.deleteStudent(STUDENT_ID);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
        assertFalse(service.saveStudent(STUDENT_ID, "", 932) == 1);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
    }
    ...
    public void tc7AddStudentGroup938Invalid() {
        service.deleteStudent(STUDENT_ID);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
        assertFalse(service.saveStudent(STUDENT_ID, STUDENT_NAME, 938) == 1);
        assertNull(studentXMLRepository.findOne(STUDENT_ID));
    }
